 ...
 */
final class Version20250704082026 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE figure ADD CONSTRAINT FK_2F57B37A7A45358C FOREIGN KEY (groupe_id) REFERENCES `group` (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
